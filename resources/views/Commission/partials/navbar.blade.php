        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ms-auto">
                <ul class="nav nav-pills fw-bold">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#ddn">Ddn</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" style="background-color: black">
                            <li><a class="dropdown-item fw-bold" href="#procedure">Procedure</a></li>
                            <li><a class="dropdown-item fw-bold" href="#payment">Payment</a></li>
                            <li><a class="dropdown-item fw-bold" href="#contact">Contact</a></li>
                            <li> <a class="dropdown-item fw-bold" href="#social">Social</a> </li>
                        </ul>
                    </li>
                </ul>
            </div>
